...
\subsection{AWS} 
que parte da AWS vai ser usada, quais serviços, como eles se comunicam, etc.


\subsection{Qdrant Cloud}
O Qdrant Cloud é um serviço gerenciado de banco de dados vetorial que oferece uma infraestrutura otimizada para o armazenamento e a consulta de dados de alta dimensionalidade, como os vetores de características faciais gerados pelo modelo ArcFace. Ele é projetado para lidar com grandes volumes de dados e fornecer respostas rápidas para consultas de similaridade, o que é essencial para aplicações de reconhecimento facial em tempo real.
