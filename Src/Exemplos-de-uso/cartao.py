...
# # Limites da cor AZUL CLARO no padrão HSV
# azul_claro_inferior = np.array([85, 50, 100])
# azul_claro_superior = np.array([125, 255, 255])
...
while True:
    ...
    #mascara = cv2.inRange(hsv, azul_claro_inferior, azul_claro_superior)
